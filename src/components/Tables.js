...
export const TransactionsTable = () => {
  ...
  const getDonations = () => {
    //https://test-andiamo.pantheonsite.io/andiamo/donaciones?_format=json
    var options = {
      method: 'GET',
      url: `https://dev-andiamo.pantheonsite.io/andiamo/familias?_format=json`,
      headers: {
  ...
  const TableRow = (props) => {
    const { nid, title, field_direccion, field_cantidad, field_referencia } = props;
        ...
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              ...
              <th className="border-bottom">Familia</th>
              <th className="border-bottom">Integrantes</th>
              <th className="border-bottom">Zona</th>
            </tr>
          </thead>
          <tbody>
            {donations.map(t => <TableRow key={`transaction-${t.nid}`} {...t} />)}
          </tbody>
        </Table>
